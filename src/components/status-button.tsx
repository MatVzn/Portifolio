    ...
    return (
        <div className="w-auto min-w-[170px] sm:min-w-[183px] relative">
            <div
                ...
                style={{
                    boxShadow: '0 0 4px rgb(119, 0, 217)',
                }}
            >
                <div
                    ...
                    style={{
                        ...
                        backgroundImage:
                            'conic-gradient(rgba(0,0,0,0), rgb(179, 86, 255), rgba(0,0,0,0) 25%)',
                        animation: 'rotate 4s linear infinite',
                    }}
                ></div>
            </div>

            <a href="https://www.sesatech.com.br/" target="_blank" className="py-2 px-4 items-center justify-center flex flex-row gap-3 rounded-full text-green-500 bg-purple-900/30 hover:bg-purple-900/40 transition-all duration-200 relative z-0">
